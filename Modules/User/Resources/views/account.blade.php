<head>
    ...
    <!--<![endif]-->
    <title>Thông tin tài khoản - Email Marketing</title>
    <!-- Normalize Styles -->
    <style type="text/css">
...
<body style="background: #ffffff; height: 100% !important; margin: 0 auto !important; padding: 0 !important; width: 100% !important; ;">
    ...
    <table cellpadding="0" cellspacing="0" style="background: #f2f2f2; border: 0; border-radius: 0; width: 100%;">
        <tbody>
            <tr>
                <td align="center" class="" style="padding: 10px;">
                        ...
                        <tbody>
                            <tr>
                                <td align="center" class="" style="width: 600px;">
                                    <table cellpadding="0" cellspacing="0" style="background: #ffffff; border: 0; border-radius: 5px; width: 100%;">
                                        <tbody>
                                            <tr>
                                                <td align="center" class="tw-card" style="padding: 0px 50px;">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="" style="padding: 20px 0; text-align: left; color: #474747; font-family: sans-serif;;">
                                                                    <p style="margin: 20px 0;; font-size: 14px; line-height: 24px;">
                                                                        <span style="font-weight: bold;;">Cảm ơn bạn đã đăng ký sử dụng dịch vụ Email Marketing của chúng tôi!</span>
                                                                    </p>
                                                                    <p style="margin: 20px 0; font-size: 14px; line-height: 24px;">
                                                                        Dưới đây là thông tin tài khoản để đăng nhập và sử dụng hệ thống:
                                                                        <br><br>
                                                                        <span style="font-weight: bold;">Tài khoản:</span> {{$email}}
                                                                        <br>
                                                                        <span style="font-weight: bold;">Mật khẩu:</span> {{$password}}
                                                                    </p>
                                                                    <p style="margin: 20px 0;; font-size: 14px; line-height: 24px; text-align:center;">
                                                                        <span style="color:rgb(255, 255, 255);background-color: #dd4b39;padding:10px 16px;max-width:252px;border-radius:5px; text-align: center">
                                                                            <a class="button-link" href="https://teamweb-backend.dev-altamedia.com" style="font-weight:bold;text-decoration:none;color:rgb(255, 255, 255);font-size:14px;line-height:24px;text-align:center;" target="_blank">
                                                                                BẮT ĐẦU NGAY NÀO...
                                                                            </a>
                                                                        </span>
                                                                    </p>
                                                                    <p style="margin: 20px 0;; font-size: 14px; mso-line-height-rule: exactly; line-height: 24px;">
                                                                        Trân trọng cảm ơn, <br>
                                                                        <span style="font-weight: bold;;">Tôi và nhóm của tôi - Email Marketing</span>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div style="background: #dd4b39;color: #ffffff;padding: 10px; font-size: 14px; border-radius: 0px 0px 5px 5px">
                                                        <span style="font-weight: bold;">Copyright © 2019 Email Marketing.</span>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
